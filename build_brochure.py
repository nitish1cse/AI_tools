...
class Website:
    ...
    def __init__(self, url):
        ...
        if soup.body:
            for no_use in soup.body(["script", "style", "img", "input"]):
                no_use.decompose()
...
def create_brochure(company_name, url):
    ...
    for chunk in stream:
        # print(getattr(chunk.choices[0].delta, "content", ""), end="")
...
view = gr.Interface(fn=create_brochure,
